...
class LaptopsInfo extends StatefulWidget {
  @override
  _LaptopsInfo createState() => _LaptopsInfo();
}

class _LaptopsInfo extends State<LaptopsInfo> {
  ...
  Widget build(BuildContext context) {
    Widget image_slider_carousel = Container(
      ...
      child: Carousel(
        boxFit: BoxFit.cover,
        images: [
          AssetImage('laptop/l1.jpg'),
          AssetImage('laptop/l2.jpg'),
          AssetImage('laptop/l3.jpg'),
        ],
