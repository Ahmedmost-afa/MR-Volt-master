...
class WashingsInfo extends StatefulWidget {
  @override
  _WashingsInfo createState() => _WashingsInfo();
}

class _WashingsInfo extends State<WashingsInfo> {
  ...
  Widget build(BuildContext context) {
    Widget image_slider_carousel = Container(
      ...
      child: Carousel(
        boxFit: BoxFit.cover,
        images: [
          AssetImage('washing/w1.jpg'),
          AssetImage('washing/w2.jpg'),
          AssetImage('washing/w3.jpg'),
        ],
